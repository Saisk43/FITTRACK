...
from PyQt5.QtWidgets import (QApplication, QWidget, QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QMessageBox,
                             QTableWidget, QTableWidgetItem, QHeaderView, QCheckBox, QLineEdit, QDateEdit)
...
class FitTrack(QWidget):
    ...
    def add_workout(self):
        ...
        if not calories or not distance or not description:
            QMessageBox.warning(self, "Error", "Don't leave any field empty")
            return
    ...
    def calculate_calories(self):
        ...
        try:
            ...
            ax.set_title("Distance vs Calorie")
